...
export default function EditCategory() {
  ...
  const loadCategory = async () => {
    ...
    try {
      setIsLoading(true);
      const foundCategory = await categoryDatabase.show(+id) as Category | null;
          ...
          <View style={styles.infoSection}>
            <View style={[styles.infoCard, styles.warningCard]}>
              ...
              <Text style={[styles.infoText, styles.warningText]}>
                Não é possível excluir categorias que possuem produtos associados. Para excluir, remova os produtos primeiro.
              </Text>
            </View>
          </View>
        </View>
